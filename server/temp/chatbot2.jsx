...
function Chatbot() {
    ...
    const [testDate, setTestDate] = useState("2014-06-04T23:34:56.084+00:00");
        ...
        <div className={styles.container}>
            <div className={styles.nav_container}>
                <nav className={styles.navbar}>
                    <div className={styles.buttons_nav_bar}>
                        ...
                        <FiPlus className={styles.new_chat_button} onClick={newChat}/>
                    </div>
                    <h1>Doctorly AI</h1>
